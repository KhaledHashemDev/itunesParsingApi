...
class ClassicsAdapter(private val songsData: MutableList<DomainSong> = mutableListOf(),
                      private var onItemClick: (DomainSong) -> Unit
) : RecyclerView.Adapter<ClassicsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClassicsViewHolder =
        ClassicsViewHolder(
    ...
    override fun onBindViewHolder(holder: ClassicsViewHolder, position: Int) =
...
class ClassicsViewHolder( private val binding: SongItemBinding
