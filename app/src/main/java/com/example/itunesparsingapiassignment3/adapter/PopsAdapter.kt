...
class PopsAdapter(private val songsData: MutableList<DomainSong> = mutableListOf(),
private var onItemClick: (DomainSong) -> Unit
) : RecyclerView.Adapter<PopsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopsViewHolder =
        PopsViewHolder(
    ...
    override fun onBindViewHolder(holder: PopsViewHolder, position: Int) =
...
class PopsViewHolder( private val binding: SongItemBinding
